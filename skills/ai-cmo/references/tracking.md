...
Then append a row to `marketing/tracking/content-log.csv`:
...
Then calculate and append to `marketing/tracking/performance.csv`:
...
Append to `marketing/tracking/revenue-attribution.csv`:
