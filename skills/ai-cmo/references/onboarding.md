...
│   ├── content/our-content/ & competitors/
│   ├── transcripts/
...
### Phase 1: Company Overview (→ `company-overview.md` + `contacts.md`)
...
- Who are the key people involved? (→ `contacts.md`)
...
### Phase 2a: Content Examples (→ seeds `marketing/knowledge/voice-guidelines.md` + `marketing/knowledge/whats-working.md`)
...
### Phase 2b: Writing Samples (→ `marketing/knowledge/voice-guidelines.md`)
...
### Phase 2c: Voice Refinement (→ `marketing/knowledge/voice-guidelines.md`)
...
Use all of Phase 2 to populate `marketing/knowledge/voice-guidelines.md` with real examples and concrete attributes rather than abstract descriptions.

---

### Phase 3: Customer Intelligence (→ `marketing/knowledge/personas-storybrand.md`)
...
### Phase 4: Goals & Benchmarks (→ `marketing/knowledge/goals-and-benchmarks.md`)
...
2. **Generate the client's `.claude/CLAUDE.md`** with:
   ...
   - Folder map (with `marketing/` subdirectory structure)
   - Brand voice quick reference
   - Current priorities
   - What's working quick hits
   - Special considerations
   - Integration configuration
3. **Initialize `marketing/knowledge/whats-working.md`** with any known patterns from the discovery (even if limited)
...
6. **Summary of what was created** — walk the user through everything that was set up:
   ...
   Shared files:
   - company-overview.md — Your company info, differentiators, competitive landscape
   - contacts.md — Key contacts and roles

   Marketing knowledge files:
   - marketing/knowledge/voice-guidelines.md — Your brand voice, tone, messaging pillars
   - marketing/knowledge/personas-storybrand.md — Your customer profiles and messaging framework
   - marketing/knowledge/goals-and-benchmarks.md — Your 90-day goals and KPIs
   - marketing/knowledge/whats-working.md — Performance insights (will fill in as you publish)

   Tracking files:
   - marketing/tracking/content-log.csv — Log each piece of content you publish
   - marketing/tracking/performance.csv — Log engagement metrics after a few days
   - marketing/tracking/revenue-attribution.csv — Track leads back to content (optional)

   Your first plans:
   - marketing/outputs/monthly-briefs/[filename] — This month's content strategy
   - marketing/outputs/weekly-briefs/[filename] — This week's specific content plan
