...
1. **Load tracking data:**
   - Read `marketing/tracking/performance.csv` and `marketing/tracking/content-log.csv`
...
6. **Propose updates to `marketing/knowledge/whats-working.md`:**
...
Use the Performance Analysis format from `output-formats.md`. Save to `marketing/outputs/` with a descriptive filename like `performance-analysis-YYYY-MM.md`.
...
1. **Review recent performance data:**
   - Last 30 days of `marketing/tracking/performance.csv`
   - Cross-reference with `marketing/tracking/content-log.csv` for context

2. **Read current `marketing/knowledge/whats-working.md`:**
...
1. **Read revenue data:**
   - Load `marketing/tracking/revenue-attribution.csv`
   - Cross-reference with `marketing/tracking/content-log.csv` for content details
...
6. **Save report** to `marketing/outputs/` with filename like `revenue-report-YYYY-MM.md`
