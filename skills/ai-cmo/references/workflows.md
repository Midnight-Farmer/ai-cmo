...
- Read through your monthly brief and weekly plan in `marketing/outputs/`
...
1. **Data Gathering (10 min):**
   - Ensure all content is logged in `marketing/tracking/content-log.csv`
   - Ensure all performance data is captured in `marketing/tracking/performance.csv`
...
4. **Goal Check (5 min):**
   - Compare current metrics against 90-day goals in `marketing/knowledge/goals-and-benchmarks.md`
...
3. Set new 90-day goals (update `marketing/knowledge/goals-and-benchmarks.md`)
4. Major update to `marketing/knowledge/whats-working.md`
